...
df=pandas.read_json("updatedSubset.json")
...
X_train, X_test, y_train, y_test = cross_validation.train_test_split(X_data, Y_data_transformed, test_size=0.2, random_state=5)
